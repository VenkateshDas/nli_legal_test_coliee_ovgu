...
'''
# File List:
RAW_TRAIN_DATA = "dataset/Sabine_training_data.xml"
...
if __name__ == "__main__":
    ...
    with open('preprocessed_training_set.json', 'w') as fp:
        json.dump(all_sentences, fp)    
        
    print('Preprocessing Complete!')
    
    print('File {} saved to {}'.format('preprocessed_training_set.json',os.getcwd()))