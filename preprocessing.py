...
1.1         26.04.2020      #Change_1   Put the bigram_.pkl, legal_words.pkl in the folder. Thus, changed filepaths.
...
"""
Description:    Returns current file path of the bigram pkl file.
Input:           
Output:      
Change Tag: #Change_1    
"""
def return_path_bigram():
    ...
    filepath = "./preprocessing/"+filename
    return filepath 


"""
Description:    Returns current file path of legal words pkl file.
Input:           
Output:  
Change Tag: #Change_1          
"""
...
Output:         index of highest frequency amonf valid options. -1 if all options are invalid. 
"""
...
def process(sentence): 
  ...
  legal_word_file_path = return_path_legal_words() #Change_1  
  ...
  bigram_file = return_path_bigram() #Change_1 
    ...
    for word in sub_t: 
        ...
        if (word): #it should not be a blank space. 
            ...
            if is_word_law2Vec is False and is_word_legal is False:
                ...
                file_op = open("word_change_log.csv","a+") 
  ...
  return sentence, has_Changes, change_type
